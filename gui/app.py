...
from utils.config import VERSION, COLORS, FILE_TYPES
from utils.logger import pick_log_tag, timestamp, save_log_file
...
from gui.calib.tab import CalibTab
...
class App:
    def __init__(self, root):
        ...
        self.symbols = None
        self.source_type = tk.StringVar(value="elf")
        self.remove_var = tk.BooleanVar(value=False)
        self.recursive_var = tk.BooleanVar(value=True)
        self.log_buffer = []
        self._log_queue = []          # 待渲染日志 (工作线程写入, 主线程批量消费)
