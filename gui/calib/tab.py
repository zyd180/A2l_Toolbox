...
from gui.calib.editors import open_editor
...
class CalibTab(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        ttk.Label(tree_frame, text='分组浏览', style='CardMuted.TLabel').pack(anchor='w')
    ...
    def apply_filter(self):
        ...
        # 抑制 selection_set 触发的事件, 显式填充一次 (确定性, 避免时序竞态)
